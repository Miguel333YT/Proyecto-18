...
function preload(){
  ...
  //aqui se cargan las imagenes del cuchillo, las frutas y el monstruo al codigo
  ...
  //aqui se añaden los sonidos del cuchillo y del game over
...
//aqui se crea el sprite del monstruo, su imagen, grupo, animacion, velocidad, lifetime y su aparicion aleatoria
function Monster(){
...
//aqui se crean los sprites de las frutas, grupo, imagen, animacion, tamaño, lifetime, y su aparicion aleatoria
function fruits(){
